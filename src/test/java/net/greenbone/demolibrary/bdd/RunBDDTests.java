...
@CucumberOptions(
        ...
        glue = "net.greenbone", //dependency injection framework, wo liegen die klassen
        features = "src/test/resources/features/", //liegen die bdd tests
        dryRun = false //tests starten und alle schritte die in den features definiert sind auch angegeben sind
        //strict = true
)
